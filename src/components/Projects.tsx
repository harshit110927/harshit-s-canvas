...
const mockProjects: Project[] = [
  {
    ...
    fullDescription: "A sophisticated RAG (Retrieval-Augmented Generation) system that allows users to chat with their documents. Built with LangChain, OpenAI embeddings, and a Next.js frontend.",
    tags: ["Next.js", "LangChain", "OpenAI", "PostgreSQL"],
  ...
  },
  {
    ...
    tags: ["React", "WebSocket", "Monaco Editor", "Redis"],
    liveUrl: "https://example.com",
    githubUrl: "https://github.com/harshit110927",
  },
  {
    ...
    fullDescription: "Complete e-commerce solution with product management, cart functionality, secure checkout via Stripe, and order tracking.",
  ...
  },
  {
    ...
    description: "Visual workflow builder for data pipelines",
    fullDescription: "Drag-and-drop interface for building and deploying machine learning pipelines. Features automatic resource allocation and monitoring.",
    tags: ["Python", "FastAPI", "React Flow", "Docker"],
    liveUrl: "https://example.com",
    githubUrl: "https://github.com/harshit110927",
  },
  {
